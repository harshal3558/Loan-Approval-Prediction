...
from src.LAP.utils import save_object, evaluate_models
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            #     repo_name="Loan-Approval-Prediction",
            #     mlflow=True
            # )
            # mlflow.set_registry_uri("https://dagshub.com/harshal3558/Loan-Approval-Prediction.mlflow")
